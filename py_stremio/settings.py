...
@dataclass
class Settings:
    ROOT_FOLDER: Path = field(default_factory=lambda: Path(os.getenv("ROOT_FOLDER", "/home/strubloid/stremio-downloads")))
    ...
    MAX_DOWNLOAD_ATTEMPTS: int = field(default_factory=lambda: int(os.getenv("MAX_DOWNLOAD_ATTEMPTS", "2")))
    ...
    SMTP_TO: str | None = field(default_factory=lambda: os.getenv("SMTP_TO"))
